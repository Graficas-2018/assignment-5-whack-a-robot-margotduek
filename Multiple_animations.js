...
function loadFBX()
{
    ...
    // loader.load( '../models/Robot/robot_idlerobot_idle.fbx', function ( object )
    {
...
function create_robot(event)
{
  for (var i = 0; i < 5; i++) 
  {
    ...
    createDeadAnimation();
    created += 1;
    document.getElementById("creados").innerHTML = created;
...
function onDocumentMouseDown(event)
{
    ...
    if ( intersects.length > 0 )
    {
        ...
        dead += 1;
        alive -= 1;
        document.getElementById("vivos").innerHTML = alive;
